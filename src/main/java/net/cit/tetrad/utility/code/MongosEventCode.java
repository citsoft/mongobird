...
public class MongosEventCode implements CodeInterface {

	private static ResourceBundle eventResource;
	private static Map<String, String> eventCode;
	
	static {
		MongosEventCode code = new MongosEventCode();
	...
	private void initEventResource(){
		eventResource = ResourceBundle.getBundle("properties/mongosEventMsg",Locale.getDefault());
	}
