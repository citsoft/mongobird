...
<%
	...
	for(int i=statusList.size()-1;i>=0;i--){
		...
		strDataSet.append(", \"<a href='#' class='deco_none' title='\"+toolTip_title(parseFloat("+ fetchRow.get("globalLock_lockTime") +"),'μs')+\"'>\"+convertMicroStoMilliS('"+fetchRow.get("globalLock_lockTime")+"')+\"</a>\"]");
	}
	strDataSet.append("]");
...
<h5><spring:message code="graph.globalLockTime"/></h5>
<table id="list" border="0" class="tb_list" summary="<spring:message code="graph.daemonDetailedGraph"/>">
	...
	<thead>
		<tr>
			...
			<th><spring:message code="graph.total"/> <spring:message code="graph.globalLockTime"/></th>
		</tr>
	</thead>
	<tbody>
		<tr>
