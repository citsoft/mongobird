...
<%
	...
	for(int i=statusList.size()-1;i>=0;i--){
		...
		strDataSet.append(", \"<a href='#' class='deco_none' title='\"+toolTip_title(parseFloat("+ fetchRow.get("connections_current") +"),'')+\"'>\"+exFormat('"+fetchRow.get("connections_current")+"')+\"</a>\"]");
	}
	strDataSet.append("]");
...
<h5><spring:message code="graph.connectionState"/> <spring:message code="graph.list"/></h5>
<table id="list" border="0" class="tb_list" summary="<spring:message code="graph.daemonDetailedGraph"/>">
	...
	<thead>
		<tr>
			...
			<th><spring:message code="graph.currentConnections"/></th>
		</tr>
	</thead>
	<tbody>
		<tr>
