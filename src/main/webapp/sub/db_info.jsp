...
<%
	...
	for(int i=statusList.size()-1;i>=0;i--){
		...
		strDataSet.append(", \"<a href='#' class='deco_none' title='\"+toolTip_title(parseFloat("+ fetchRow.get("dataSize") +"),'Byte')+\"'>\"+sizeFormat('"+fetchRow.get("dataSize")+"')+\"</a>\"]");
	}
	strDataSet.append("]");
...
<h5><spring:message code="common.dbSize"/></h5>
