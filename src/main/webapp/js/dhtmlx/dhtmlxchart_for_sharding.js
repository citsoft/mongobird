/*
2012 August 23
2012 November 20 변경한 코드를 검색하려면 'changeCode'를 검색하면 됨.
*/
...
//			minValue = parseFloat(this._settings.xAxis.start);
			//changeCode 상단은 원래 코드. 하단은 바꾼내용임.  0부터 barHmaxValue변수에 담긴 max값까지 그래프 범위가 된다. 
		   maxValue = parseFloat(barHmaxValue);
				minValue = parseFloat(0);
		}
	...
	*/
	...
	_drawHYAxis:function(ctx,data,point0,point1,cellWidth,yAxisX){
		...
		//changeCode 하단 코드 주석처리. barH에서 yaxis를 넣었을 때 line이 보이지 않도록 한다.
