...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/dbGraph_js/deviceDbGraph.js"></script>
</head>
...
<div id="container">
	...
	<div id="content_graph">
		<div class="graph_sub_menu">
			<spring:message code="menu.db" /> > <spring:message code="menu.instance" />
		</div>
		...
		<input type="hidden" id="dsNameLst" name="dsNameLst" value="dbDataSize"/>
		<input type="hidden" id="dsNameLst" name="dsNameLst" value="dbIndexSize"/>
		<div id="menu_graph">
			<ul>
