...
<div id="contents_graph">
	<div class="left_graph">
		<c:choose>
			<c:when test="${'acc'==comm.dstype}">
					<input type="hidden" id="consolFun" name="consolFun" value="LAST"/>
	...
	<div class="right_graph txtRight">
		<c:if test="${comm.type_gubun != 'allDb'}">
			<label id="enlarge" onClick="sortClick()" class="text_top"></label>
		</c:if>
	</div> 
	<fieldset class="all_graph border">
		<div class="all_graph">
			<fieldset class="slider_bar">
				...
				<div class="text_left">
					<input type="image" src="./img/btn_apply<spring:message code="common.img"/>.gif" width="45" height="20" alt="apply" class="btn_apply" id="btn_apply" onclick='setGraph(); return false;'>
				</div>
		</div>
