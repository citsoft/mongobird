...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/lockGraph_js/deviceLockGraph.js"></script>
</head>
...
<div id="container">
	...
	<h1>
		<img src="./img/Subtit_daemonLock<spring:message code="common.img"/>.png">
	</h1>
