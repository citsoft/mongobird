...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/lockGraph_js/groupLockGraph.js"></script>
</head>
...
<div id="container">
	...
	<h1>
			<img src="./img/Subtit_GroupLock<spring:message code="common.img"/>.png">
	</h1>
