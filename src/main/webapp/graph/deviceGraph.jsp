...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/subgraph_js/deviceGraph.js"></script>
</head>
...
<div id="container">
	...
	<div id="content_graph">
		<div class="graph_sub_menu">
			<spring:message code="menu.normal_status" /> > <spring:message code="menu.instance" />
		</div>
