...
<script type="text/javascript">
	$(document).ready( function() {
		...
		$('#divBtn').click( function(event){
			var url = "popup_event.do";
			var dataToSend = $('input:checkbox', oTable.fnGetNodes()).serialize();
			//dataToSend = dataToSend.replace(/&/gi, "AND");
			if(dataToSend==""){
				alert("<spring:message code="common.nolist"/>");
			}else{}
				var callback = function(dataReceived){
				...
				var typeOfData = 'html';
				window.open("popup_event.do?"+dataToSend,"Login","width=800,height=200,menubar=no,toolbar=no,location=no,status=no,resizable=no,scrollbars=no");
		});
	...
	<div id="container">
		...
		<div id="content_m">
			...
			<form name="listForm" id="listForm">
				...
				<div class="pagbtn" id="divBtn"><a href = "#"><input type="button" id = "divBtn" value="이벤트 그룹 정의"  ></a> </div>
			</form>
			</div>
